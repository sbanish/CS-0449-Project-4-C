// Shawn Banish - CS 0449 Project 4
...
// Reading  /dev/dice file for rand num
int dice_roll(){
  unsigned int output;
 ...
 // Display score for upper, lower, total, bonus
void display_score(){
...
// Have user assign a roll to a category
...
// reroll the dice the user wants to
void reroll(){
